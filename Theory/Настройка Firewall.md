...
Пошаговая настройка фильтрации на **MikroTik** между **blue.net** и **red.net** для [Второй лабораторной работы](../Lab/Вторая%20лабораторная%20работа.md).
...
Предусловие: IP на интерфейсах уже назначены (первая / вторая лабораторная), DNS в DMZ настроен ([Настройка DMZ в Alpine](Настройка%20DMZ%20в%20Alpine.md)).
...
Сравнение с Cisco и Juniper: [Конспект MikroTik Cisco Juniper](Конспект%20MikroTik%20Cisco%20Juniper.md).
...
Cisco ASA и Ubuntu из старых черновиков в этом курсе **не используются**: экран — MikroTik, DNS — Alpine. Для ориентира по вендорам см. [Конспект MikroTik Cisco Juniper](Конспект%20MikroTik%20Cisco%20Juniper.md).
